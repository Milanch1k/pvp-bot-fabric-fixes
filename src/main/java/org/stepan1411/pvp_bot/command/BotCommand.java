...
public class BotCommand {
                ...
                CommandManager.literal("pvpbot")
                        ...
                        .then(CommandManager.literal("settings")
                                ...
                                .then(CommandManager.literal("autoarmor")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("autoarmor: " + BotSettings.get().isAutoEquipArmor()), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("autoweapon")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("autoweapon: " + BotSettings.get().isAutoEquipWeapon()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("droparmor")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("droparmor: " + BotSettings.get().isDropWorseArmor()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("dropweapon")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("dropweapon: " + BotSettings.get().isDropWorseWeapons()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("dropdistance")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("dropdistance: " + BotSettings.get().getDropDistance()), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("interval")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("interval: " + BotSettings.get().getCheckInterval() + " ticks"), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("minarmorlevel")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("minarmorlevel: " + BotSettings.get().getMinArmorLevel()), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("combat")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("combat: " + BotSettings.get().isCombatEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("revenge")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("revenge: " + BotSettings.get().isRevengeEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("autotarget")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("autotarget: " + BotSettings.get().isAutoTargetEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("targetplayers")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("targetplayers: " + BotSettings.get().isTargetPlayers()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("targetmobs")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("targetmobs: " + BotSettings.get().isTargetHostileMobs()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("targetbots")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("targetbots: " + BotSettings.get().isTargetOtherBots()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("criticals")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("criticals: " + BotSettings.get().isCriticalsEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("ranged")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("ranged: " + BotSettings.get().isRangedEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("mace")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("mace: " + BotSettings.get().isMaceEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("attackcooldown")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("attackcooldown: " + BotSettings.get().getAttackCooldown() + " ticks"), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("meleerange")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("meleerange: " + BotSettings.get().getMeleeRange()), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("movespeed")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("movespeed: " + BotSettings.get().getMoveSpeed()), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("bhop")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("bhop: " + BotSettings.get().isBhopEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("bhopcooldown")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("bhopcooldown: " + BotSettings.get().getBhopCooldown() + " ticks"), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("jumpboost")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("jumpboost: " + BotSettings.get().getJumpBoost()), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("idle")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("idle: " + BotSettings.get().isIdleWanderEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("idleradius")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("idleradius: " + BotSettings.get().getIdleWanderRadius()), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("friendlyfire")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("friendlyfire: " + BotSettings.get().isFriendlyFireEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("misschance")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("misschance: " + BotSettings.get().getMissChance() + "%"), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("mistakechance")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("mistakechance: " + BotSettings.get().getMistakeChance() + "%"), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("percent", IntegerArgumentType.integer(0, 100))
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("reactiondelay")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("reactiondelay: " + BotSettings.get().getReactionDelay() + " ticks"), false);
                                            return 1;
                                        })
                                ...
                                .then(CommandManager.literal("prefersword")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("prefersword: " + BotSettings.get().isPreferSword()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("shieldbreak")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("shieldbreak: " + BotSettings.get().isShieldBreakEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("autoshield")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("autoshield: " + BotSettings.get().isAutoShieldEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("autopotion")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("autopotion: " + BotSettings.get().isAutoPotionEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("autototem")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("autototem: " + BotSettings.get().isAutoTotemEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("totempriority")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("totempriority: " + BotSettings.get().isTotemPriority()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("escapefromcobweb")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("escapefromcobweb: " + BotSettings.get().isTotemPriority()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                                    BotSettings.get().setEscapeFromCobweb(BoolArgumentType.getBool(ctx, "value"));
                                                    ctx.getSource().sendFeedback(() -> Text.literal("Escape from cobweb: " + BotSettings.get().isTotemPriority()), true);
                                                    return 1;
                                                })
                                        )
                                )
                                ...
                                .then(CommandManager.literal("retreat")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("retreat: " + BotSettings.get().isRetreatEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("autoeat")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("autoeat: " + BotSettings.get().isAutoEatEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
                                ...
                                .then(CommandManager.literal("automend")
                                        .executes(ctx -> {
                                            ctx.getSource().sendFeedback(() -> Text.literal("automend: " + BotSettings.get().isAutoMendEnabled()), false);
                                            return 1;
                                        })
                                        .then(CommandManager.argument("value", BoolArgumentType.bool())
                                                .executes(ctx -> {
    ...
    private static int showSettings(ServerCommandSource source) {
        ...
        source.sendFeedback(() -> Text.literal("escapefromcobweb: " + s.isEscapeFromCobweb()), false);
